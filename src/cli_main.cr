...
if action == "stats"
  ...
  puts "Usage: #{PROGRAM_NAME} ACTION [ARGUMENTS]"
  puts ""
  ...
  puts "Actions:"
  puts ""
  puts "  stats (initial_heap) (first_change_heap) (second_change_heap)"
  puts "    Get a list of objects allocated in the first change and not freed"
  puts "    in the second."
  puts ""
  puts "  root (first_change_heap) (sample_address1) (sample_address2) ..."
